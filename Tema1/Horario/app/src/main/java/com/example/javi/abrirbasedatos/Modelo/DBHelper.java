...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void open() throws SQLException {
        ...
        Log.d("dbHelper", "Abierta la BBDD");
    }
    ...
    private void createDataBase() throws IOException {
        ...
        if (!checkDataBase()) {
            ...
            Log.d("dbHelper", "Base creada");
            try {
                copyDataBase();
                Log.d("dbHelper", "Base copiada");
            } catch (IOException e) {
    ...
    private void copyDataBase() throws IOException {
        ...
        if (myInput == null)
            Log.d("dbhelper", "no se encontro el archivo MainActivityDos");
